...
(function(){
  ...
  function evaluateInputsMap(valuesMap) {
    ...
    if (message) {
      message = `<p><strong>Summary:</strong> ${abnormalCount} test value(s) outside the normal range.</p> <p><strong>Disclaimer:</strong>⚠️LabInsight Mini provides educational information only and does not replace professional medical advice.</p>` + message;
