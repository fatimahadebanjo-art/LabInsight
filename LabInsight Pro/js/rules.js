const testRules = {
        hb: { name: "Hemoglobin (g/dL)", ranges: [
          { max: 12, category: "abnormal", msg: "LOW â€” may suggest anemia, which can cause tiredness, weakness or shortness of breath.",
            questions: ["Could this be anemia?", "Do I need iron supplements or further tests?"] },
          { max: 16, category: "normal", msg: "NORMAL â€” hemoglobin is within the healthy range, suggesting healthy oxygen transport in the blood." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may be due to dehydration or other factors.",
            questions: ["Could dehydration be causing this?", "Do I need further tests for blood disorders?"] }
        ]},
        wbc: { name: "White Blood Cells (x10â¹/L)", ranges: [
          { max: 4, category: "abnormal", msg: "LOW â€” your immune system may be weakened.",
            questions: ["Is my immune system suppressed?", "Do I need more tests for infections?"] },
          { max: 11, category: "normal", msg: "NORMAL â€” white blood cell count is healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may indicate infection, inflammation or stress.",
            questions: ["Could this mean I have an infection?", "Do I need antibiotics or further tests?"] }
        ]},
        platelets: { name: "Platelets (x10â¹/L)", ranges: [
          { max: 150, category: "abnormal", msg: "LOW â€” risk of bleeding or easy bruising. It may also reduce your ability to fight infections",
            questions: ["Am I at risk of bleeding?", "Do I need treatment for low platelets?"] },
          { max: 450, category: "normal", msg: "NORMAL â€” platelet count is healthy. This suggests a healthy immune response." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may be linked to inflammation or bone marrow changes. It may also increase the risk of clotting in some cases",
            questions: ["What could cause high platelets?", "Do I need further blood tests?"] }
        ]},
        sugar: { name: "Blood Sugar (mg/dL)", ranges: [
          { max: 70, category: "abnormal", msg: "LOW â€” may cause dizziness or shakiness (hypoglycemia).",
            questions: ["Could my diet or medications be causing low sugar?", "How can I prevent hypoglycemia episodes?"] },
          { max: 99, category: "normal", msg: "NORMAL â€” fasting blood sugar is healthy." },
          { max: 125, category: "borderline", msg: "BORDERLINE â€” in the prediabetes range, lifestyle changes may help.",
            questions: ["Am I at risk of developing diabetes?", "What lifestyle changes should I make now?"] },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may indicate diabetes risk.",
        ...
        cholesterol: { name: "Total Cholesterol (mg/dL)", ranges: [
          { max: 200, category: "normal", msg: "Desirable â€” cholesterol is in a healthy range." },
          { max: 239, category: "borderline", msg: "Borderline high â€” keep an eye on diet and exercise.",
            questions: ["Should I change my diet to lower cholesterol?", "Do I need medication at this stage?"] },
          { max: Infinity, category: "abnormal", msg: "High â€” increases risk of heart disease.",
        ...
        triglycerides: { name: "Triglycerides (mg/dL)", ranges: [
          { max: 150, category: "normal", msg: "Desirable â€” triglycerides are healthy." },
          { max: 199, category: "borderline", msg: "Borderline high â€” may need lifestyle changes.",
            questions: ["Should I change my diet to lower triglycerides?", "Do I need medication?"] },
          { max: 499, category: "abnormal", msg: "High â€” raises risk of heart disease.",
            questions: ["What is my risk of heart disease?", "What treatments can help lower triglycerides?"] },
          { max: Infinity, category: "abnormal", msg: "Very high â€” risk of pancreatitis.",
            questions: ["Am I at risk of pancreatitis?", "Do I need urgent treatment?"] }
        ]},
        hdl: { name: "HDL Cholesterol (mg/dL)", ranges: [
          { max: 40, category: "abnormal", msg: "LOW â€” less protective against heart disease.",
            questions: ["How can I raise my HDL?", "Do I need lifestyle changes?"] },
          { max: 59, category: "normal", msg: "NORMAL â€” HDL is healthy." },
          { max: Infinity, category: "normal", msg: "HIGH â€” protective for heart health." }
        ]},
        ldl: { name: "LDL Cholesterol (mg/dL)", ranges: [
          { max: 100, category: "normal", msg: "Optimal â€” LDL is healthy." },
          { max: 129, category: "normal", msg: "Near optimal â€” acceptable range." },
          { max: 159, category: "borderline", msg: "Borderline high â€” may need lifestyle changes.",
            questions: ["Should I change my diet to lower LDL?", "Do I need medication?"] },
          { max: 189, category: "abnormal", msg: "High â€” increases risk of heart disease.",
            questions: ["What is my risk of heart disease?", "Do I need cholesterol-lowering medication?"] },
          { max: Infinity, category: "abnormal", msg: "Very high â€” serious heart disease risk.",
            questions: ["Do I need urgent treatment?", "What lifestyle changes are most important?"] }
        ]},
        bun: { name: "Urea / BUN (mg/dL)", ranges: [
          { max: 7, category: "abnormal", msg: "LOW â€” may suggest liver issues or poor nutrition.",
            questions: ["Could this mean liver problems?", "Do I need nutrition support?"] },
          { max: 20, category: "normal", msg: "NORMAL â€” kidney function looks healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may indicate kidney problems or dehydration.",
            questions: ["Could dehydration be causing this?", "Do I need kidney function tests?"] }
        ]},
        sodium: { name: "Sodium (mmol/L)", ranges: [
          { max: 135, category: "abnormal", msg: "LOW â€” can cause headaches, nausea, or confusion (hyponatremia).",
            questions: ["What could cause low sodium?", "Do I need fluid or salt adjustments?"] },
          { max: 145, category: "normal", msg: "NORMAL â€” sodium levels are healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” can cause thirst, weakness, or restlessness (hypernatremia).",
            questions: ["What could cause high sodium?", "Do I need to change my fluid intake?"] }
        ]},
        potassium: { name: "Potassium (mmol/L)", ranges: [
          { max: 3.5, category: "abnormal", msg: "LOW â€” may cause muscle weakness or cramps (hypokalemia).",
            questions: ["Could medications be lowering my potassium?", "Do I need supplements?"] },
          { max: 5.0, category: "normal", msg: "NORMAL â€” potassium levels are healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may cause irregular heartbeat or weakness (hyperkalemia).",
            questions: ["Is my heart at risk?", "Do I need urgent treatment?"] }
        ]},
        chloride: { name: "Chloride (mmol/L)", ranges: [
          { max: 98, category: "abnormal", msg: "LOW â€” blood may be more alkaline than usual, which can cause cramps or confusion.",
            questions: ["What could cause low chloride?", "Do I need further tests for acid-base balance?"] },
          { max: 106, category: "normal", msg: "NORMAL â€” chloride levels are healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” blood may be more acidic than usual, which can cause fatigue or rapid breathing.",
        ...
        creatinine: { name: "Creatinine (mg/dL)", ranges: [
          { max: 0.6, category: "abnormal", msg: "LOW â€” may reflect low muscle mass.",
            questions: ["Does this mean I have low muscle mass?", "Do I need further kidney tests?"] },
          { max: 1.3, category: "normal", msg: "NORMAL â€” kidney function looks healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may indicate kidney problems.",
            questions: ["Do I need further kidney tests?", "Should I see a kidney specialist?"] }
        ]},
        alt: { name: "ALT (U/L)", ranges: [
          { max: 40, category: "normal", msg: "NORMAL â€” ALT is healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may suggest liver stress or injury.",
            questions: ["Could this mean liver damage?", "Do I need further liver tests?"] }
        ]},
        ast: { name: "AST (U/L)", ranges: [
          { max: 40, category: "normal", msg: "NORMAL â€” AST is healthy." },
          { max: Infinity, category: "abnormal", msg: "HIGH â€” may suggest liver or muscle stress.",
